...
contract ReviewController {
    ...
    event NewSubmission(bytes32 identifier, address user);
    event NewChallenge(bytes32 identifier, address disputer);
    event NewWithdrawal(bytes32 identifier, address user);
    // event 
    ...
    function resolveDispute(bytes32 identifier) public
    {
    ...
    function withdrawAfterDispute() public
    {

    }

    // function withdrawMultiple(uint[] identifiers memory) public
