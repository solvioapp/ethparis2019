...
db.addResource2Topic('Ethereum', 'A Next-Generation Smart Contract and Decentralized Application Platform', 'https://github.com/ethereum/wiki/wiki/White-Paper')
db.addResource2Topic('merkle tree', 'Blockchain Fundamentals #1: What is a Merkle Tree?', 'https://medium.com/byzantine-studio/blockchain-fundamentals-what-is-a-merkle-tree-d44c529391d7')
db.addResource2Topic('merkle tree', 'Merkling in Ethereum', 'https://blog.ethereum.org/2015/11/15/merkling-in-ethereum/')
...
db.addReview2Resource(1400, db.hash('https://github.com/ethereum/wiki/wiki/White-Paper'), 7, 100, [
	{
		topic: 'merkle tree',
		weight: 3
	},
...
db.addReview2Resource(14001, db.hash('https://medium.com/byzantine-studio/blockchain-fundamentals-what-is-a-merkle-tree-d44c529391d7'), 5, 20, [], 'A good intro to Merkle trees')

db.addReview2Resource(14002, db.hash('https://blog.ethereum.org/2015/11/15/merkling-in-ethereum/'), 8, 20, [], "Very good explanation by Vitalik Buterin on usage of Merkle Patricia trees in Ethereum")
